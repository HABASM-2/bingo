...
const EXACT_MAP: Record<string, TranslationKey> = {
  ...
  "This round is no longer open": "lotto.roundClosed",
  "Not enough open positions": "lotto.roomFull",
  "One or more numbers were reserved by another player": "lotto.numbersTaken",
